...
## (on_fire, fire_owner, floor_type, corpse_count, feature_owner, feature_durability),
...
## Владелец — для станций/РСП. Высота укрытия задаётся при установке через set_feature().
